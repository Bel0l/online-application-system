...
const SideBar = () => {
  return (
    <div className="h-screen bg-[#1F4887] flex">
      ...
      <aside
        id="default-sidebar"
        className="bg-[#1F4887] left-0 z-40 w-64 h-screen overflow-y-auto transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto border-2 bg-[#4470B2]">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Add Roles</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Edit Roles</span>
              </Link>
            </li>
            <li>
              <Link
